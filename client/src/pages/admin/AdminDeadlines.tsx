  ...
  return (
    <div style={{ background: C.g100, fontFamily: "'Inter', sans-serif", color: C.navy, minHeight: "100vh" }}>
      ...
      <div style={{ ...headerGradient, padding: "32px 36px 28px" }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          <div>
            ...
            <p style={{ fontSize: 12, color: "rgba(255,255,255,.5)", marginTop: 4 }}>Configure los días hábiles máximos permitidos para completar cada etapa</p>
          </div>
      ...
      <div style={footerStyle}>
        <span style={footerText}>Prodigio PMO — Plazos Máximos</span>
