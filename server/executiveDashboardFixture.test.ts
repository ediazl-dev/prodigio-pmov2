...
describe("Fixture ejecutivo Tanner", () => {
  it("mantiene el fixture del 17-ago-2026 explícitamente separado de producción", () => {
    ...
    expect(resolveExecutiveDashboardCutoff({ projectId: 180002 })).toMatchObject({ date: "2026-08-17", kind: "fixture", productionSnapshotId: null });
  });

  it("prioriza un snapshot productivo por sobre el fixture", () => {
