...
export const recurringServicePenalties = mysqlTable("recurring_service_penalties", {
  ...
  evidenceFileKey: varchar("evidenceFileKey", { length: 500 }),
  evidenceMimeType: varchar("evidenceMimeType", { length: 150 }),
  evidenceFileSize: int("evidenceFileSize"),
  evidenceSha256: varchar("evidenceSha256", { length: 64 }),
  evidenceUploadedAt: timestamp("evidenceUploadedAt"),
  evidenceUploadedBy: int("evidenceUploadedBy"),
  createdBy: int("createdBy"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
});
