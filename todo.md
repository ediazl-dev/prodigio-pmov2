...
- [x] M2: Implementar atribución por servicio, período, moneda y estados de reconciliación explícitos.
- [x] M3: Separar configuración SLA, cobertura JSM, medición y cumplimiento; corregir incidentes, reportes y formalidad.
...
- [ ] Q1: Crear esquema aditivo para artefactos, decisiones, asociaciones, excepciones y snapshots.
